...
let leastCommonDenominator = 1
for (let monkey = 0; monkey < monkeyList.length; monkey++) {
    leastCommonDenominator *= monkeyList[monkey].divisible_amount
}
...
for (let round = 0; round < 10000; round++) {
    for (let monkey = 0; monkey < monkeyList.length; monkey++) {
        ...
        for (let i = 0; i < currentMonkey.item_list.length; i++) {
            ...
            let newWorry = currentMonkey.determine_new_worry(startWorry) % leastCommonDenominator
